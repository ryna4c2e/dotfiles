...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(scala-mode flycheck-haskell company sbt-mode yatex use-package rust-mode rainbow-delimiters markdown-mode hindent hi2 exec-path-from-shell company-ghc avy))))
